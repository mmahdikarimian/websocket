...
package ir.javahosting.jhshell.net;

import ir.javahosting.jhshell.main.ShellConnector;
import ir.javahosting.jhshell.io.WebSocketServerInputStream;
...
public class WebSocket extends Socket {
    public ShellConnector shellConnector =null;
    /**
    ...
    public void setShellConnector(ShellConnector obj){
        this.shellConnector =obj;
    }
    @Override
    ...
    public final WebSocketServerInputStream getInputStream()
            throws IOException {
        if (webSocketServerOutputStream == null) {
            this.getOutputStream();
        }
        if (webSocketServerInputStream == null) {
            webSocketServerInputStream = new WebSocketServerInputStream(
                        socket.getInputStream(), webSocketServerOutputStream);
        }
        return webSocketServerInputStream;
    }
    ...
    public final WebSocketServerOutputStream getOutputStream()
            throws IOException {
        if (webSocketServerOutputStream == null) {
            webSocketServerOutputStream = new WebSocketServerOutputStream(socket.getOutputStream());
        }
        return webSocketServerOutputStream;
    }
    ...
    public final String toString() {
        return "WebSocket{" +
                "jhssh=" + shellConnector +
                ", socket=" + socket +
                ", wssis=" + webSocketServerInputStream +
                ", wssos=" + webSocketServerOutputStream +
                "}\n\n";
    }
     ...
     */
    private WebSocketServerInputStream webSocketServerInputStream = null;
     ...
     */
    private WebSocketServerOutputStream webSocketServerOutputStream = null;
}
